...
static const char *tags[] = { "main", "www", "dev", "news", "chat", "mail" };
...
static const char *bkcmd[]  = { "dmenu-bk", NULL };

/* navigate through tabs include */
#include "shiftview.c"

/* volume and backlight keys include */
